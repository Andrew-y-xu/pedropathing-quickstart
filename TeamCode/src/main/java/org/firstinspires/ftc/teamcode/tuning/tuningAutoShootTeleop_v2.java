...
@TeleOp(name="Tuning AutoShootTeleop_v2")
public class tuningAutoShootTeleop_v2 extends OpMode {
...
//    Servo convey;
    ...
    boolean gamePad1bIsPressed = false;
...
///***************************/
        ...
        gamePad1xIsPressed = ifPressed(gamepad1.x);
        gamePad1yIsPressed = ifPressed(gamepad1.y);

        // Stop the Flywheel
        if (gamepad1.right_bumper) {
            //shooter_value = 0.0;
            autoShoot.setFlywheelPower(0.0);
            autoShoot.setAnglePosition(0.5);
        }
        ...
        if (servoDebounce.milliseconds() > 150) {
            if (gamepad1.a && !gamePad1aIsPressed) {
                //servo_value += 0.025;
                autoShoot.setAnglePosition(autoShoot.getAnglePosition() + 0.025);
                servoDebounce.reset();
            } else if (gamepad1.b && !gamePad1bIsPressed) {
                //servo_value -= 0.025;
                autoShoot.setAnglePosition(autoShoot.getAnglePosition() - 0.025);
                servoDebounce.reset();
            }
        }
        gamePad1aIsPressed = ifPressed(gamepad1.a);
        gamePad1bIsPressed = ifPressed(gamepad1.b);
