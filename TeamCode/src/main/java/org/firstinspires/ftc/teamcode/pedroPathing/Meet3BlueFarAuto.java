...
@Autonomous
public class Meet3BlueFarAuto extends OpMode {
    DcMotor flywheel;
    Servo hoodservo;
    Servo slot1;
    Servo slot2;
...
/**** Shooting Stuff ***/
    ...
    public void init() {
        ...
        paths = new Meet3BlueFarAuto.Paths(follower);
    ...
    public void autonomousPathUpdate() throws InterruptedException {
        ...
        switch (pathState) {
            ...
            case 101: // wait for Path1 to finish (now standing still at hub)
                if (flickerDone()) {
                    intakeMode = Meet3BlueFarAuto.IntakeMode.INTAKE;
