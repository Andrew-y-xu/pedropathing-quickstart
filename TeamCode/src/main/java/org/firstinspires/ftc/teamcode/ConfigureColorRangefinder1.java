...
@TeleOp
public class ConfigureColorRangefinder1 extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
       ...
       /* Using this example configuration, you can detect both artifact colors based on which pin is reading true:
        ...
        crf.setPin0DigitalMaxDistance(ColorRangefinder.DigitalMode.HSV, 25.4); // 10mm or closer requirement
        crf.setPin1Digital(ColorRangefinder.DigitalMode.HSV, 110 / 360.0 * 255, 140 / 360.0 * 255); // green
        crf.setPin1DigitalMaxDistance(ColorRangefinder.DigitalMode.HSV, 25.4); // 10mm or closer requirement
    }
}
