...
@Autonomous
public class tuningAutoPathOnly extends OpMode {
    ...
    public void init(){
        ...
        autoVision  = new AutoVision(limelight);
        telemetry.update();
    }
    ...
    public void loop(){
        ...
        telemetry.addData("CurrentPath(autoPath): ", autoPath.getPathState() );

        telemetry.addData("----- Shooter Data -----", null);
        telemetry.addData("AutoShoot(FlyWheel Power): ", autoShoot.getFlywheelPower() );
        telemetry.addData("AutoShoot(Hood Position): ", autoShoot.getAnglePosition() );

        telemetry.addData("----- Limelight Data -----", null);
        telemetry.addData("Limelight: ", String.valueOf(autoVision.isAprilTagFound()) );
        telemetry.addData("LimeLight(ty): ", autoVision.getLimelight_Ty() );
        telemetry.addData("LimeLight(tx): ", autoVision.getLimelight_Tx() );
